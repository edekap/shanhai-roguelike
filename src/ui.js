...
function showModeSelect(){
  ...
  const html='<div style="text-align:center;padding:12px;font-family:"PingFang SC","Microsoft YaHei",sans-serif">'+
    '<h2 style="color:#ffd700;letter-spacing:3px;margin-bottom:8px">⚔️ 选择模式</h2>'+
    '<p style="color:#8b949e;font-size:12px;margin-bottom:12px">难度：<span style="color:'+diff.color+';font-weight:bold">'+diff.icon+' '+diff.name+'</span></p>'+
    '<div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap;margin:8px 0">'+
      '<button class="action-btn" id="modeAdventure" style="flex:1;min-width:90px;max-width:140px;font-size:14px;letter-spacing:1px;flex-direction:column;gap:4px"><span style="font-size:32px">🗺️</span>冒险模式<span style="font-size:10px;color:#ffd700">新手推荐</span></button>'+
      '<button class="action-btn" id="modeTrial" style="flex:1;min-width:90px;max-width:140px;font-size:14px;letter-spacing:1px;flex-direction:column;gap:4px;background:linear-gradient(135deg,rgba(240,136,62,0.3),rgba(240,136,62,0.1));border-color:#f0883e"><span style="font-size:32px">🐉</span>Boss试炼<span style="font-size:10px;color:#f0883e">挑战自我</span></button>'+
      '<button class="action-btn" id="modeEndless" style="flex:1;min-width:90px;max-width:140px;font-size:14px;letter-spacing:1px;flex-direction:column;gap:4px;background:linear-gradient(135deg,rgba(188,140,255,0.3),rgba(188,140,255,0.1));border-color:#bc8cff"><span style="font-size:32px">♾️</span>无尽模式<span style="font-size:10px;color:#bc8cff">打到爽</span></button>'+
    '</div></div>';
  const modal=_showGearModal(html);
...
function gameOver(){
  ...
  ov.innerHTML=`<div class="sj-layer-sky"></div>
     ...
     <div class="sj-col-right">
      <div class="menu-section">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;justify-content:center">
          <button class="action-btn" id="startBtn" style="width:100%;max-width:360px;padding:18px;font-size:22px;letter-spacing:4px;background:linear-gradient(135deg,#ffd700,#ff8c42);border:2px solid #ffd700;box-shadow:0 0 24px rgba(255,215,0,0.5);animation:pulseGlow 2s ease-in-out infinite;margin:8px auto;display:block;border-radius:12px">⚔️ 开始冒险</button>
        </div>
