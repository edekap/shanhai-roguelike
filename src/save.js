...
const CONFIG = {
  ...
  ENEMY_TYPES: {
    ...
    runner:    { size: 13, speed: 130, health: 2, score: 9,  xp: 2, color: '#9d7fd1', shape: 'imp',      tier: 1 },  // 魍魉：紫色小鬼
    tank:      { size: 24, speed: 45,  health: 6, score: 18, xp: 4, color: '#8a8a8a', shape: 'golem',    tier: 2 },  // 石灵：灰色石头人
    shooter:   { size: 18, speed: 55,  health: 3, score: 15, xp: 3, color: '#c4a8ff', shape: 'shaman',   tier: 2, shoots: true, shootCooldown: 2.2 }, // 巫祝
    ...
    taunt:     { size: 28, speed: 32,  health: 16,score: 34, xp: 8, color: '#b0a090', shape: 'troll',    tier: 3, taunt: true },  // 山魈
